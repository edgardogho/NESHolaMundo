...
vblankwait2:      ; Second wait for vblank, PPU is ready after this
  ...
  ;Limpiamos la posX y posY
  LDA #0
  STA posX
  STA posY
  
  ;En el sprite 0, cargamos la flecha ($41)
  ;el sprite almacena:
  ;	 Posicion Y
  ;	 Indice ($41)
  ;  Atributos: FlipH ; FlipV ; Prioridad; 3xNC ; Paleta (00~01~10~11)
  ;	 Posicion X
  LDA #$41
  STA $0201 ;Indice
  LDA #%00000000
  STA $0202
  ;Luego PosX y PosY se avanzan durante NMI
...
nmi:
  ...
  ;Leemos el joystick
  JSR SUBReadJoy
  ;Ahora JoystickPress tiene un valor distinto a cero
  ;si se apreto algun boton. Miramos derecha, izquierda, arriba y abajo.
  
  LDA JoystickPress
  AND #%00000100
  BEQ MiroAbajo
  ;Si no salta, apreto arriba
  INC posY
...
FinJoystick:
  ...
  ;Ahora debemos copiar el sprite a la PPU, usamos DMA para eso:
